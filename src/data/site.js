...
export const site = {
  ...
  domain: "https://granitebayfencing.com",
  phoneDisplay: "(916) 906-2254",
  phoneTel: "+19169062254",
  license: "1089233",
  email: null,
  yearsExperience: 40,
  priceRange: "$$",
  parentUrl: "https://twinriversfence.com/",
  googleReviewsUrl: "https://maps.app.goo.gl/rXBxsJXV2E6Z3Luu6",
  googleMapsUrl: "https://maps.app.goo.gl/rXBxsJXV2E6Z3Luu6",
  address: {
    locality: "Granite Bay",
    region: "CA",
    country: "US",
  },
  geo: { latitude: 38.7632, longitude: -121.1638 },
  areaServed: [
    "Granite Bay",
    "Loomis",
  ],
  socialSameAs: [
    "https://maps.app.goo.gl/rXBxsJXV2E6Z3Luu6",
...
export const footerColumns = [
  {
    ...
    links: [
      ...
      { href: "/wood-fencing/", label: "Wood Fence Contractors" },
  ...
  },
  {
    title: "Company",
    links: [
      { href: "https://twinriversfence.com/", label: "Twin Rivers Fence" },
