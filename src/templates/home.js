...
import { escapeHtml, faqSchema, renderLayout, riverContactSection } from "./layout.js";
...
export function renderHomePage() {
  ...
  <section class="dark-section who">
    <div class="who-grid">
      <div class="who-copy"><h2>A fence contractor that understands Granite Bay properties.</h2><p>Twin Rivers Fence is a licensed contractor (#${site.license}) serving Granite Bay, California with fence installation, repair, custom gates, and commercial fencing — backed by real experience with Placer County HOAs, large-lot layouts, and hillside retaining-wall integrations.</p><p>Recent local scopes commonly involve Hidden Lakes and Los Lagos HOA standards, Treelake Village view considerations, and long perimeter runs near Auburn Folsom Road. We plan for decomposed granite, oak roots, retaining-wall transitions, Folsom Lake wind exposure, and mixed-material boundaries before recommending a system.</p><p class="license">Licensed Contractor #${site.license} — Granite Bay, California</p></div>
  ...
  ${riverContactSection({
    ...
    note: "Tell us about your Granite Bay fence project — we will give you a straight answer and a real quote.",
  })}`;
